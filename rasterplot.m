...
switch nin
 ...
 % plot spikes
  ...
  if (showlabels)
    xlabel('Time (ms)','Interpreter','Latex','fontsize',35);
    ylabel('Neurons','Interpreter','Latex','fontsize',35);
 % set(gca,'FontSize',28)
 % xlabel('Preferred Orientation (rads)','Interpreter','Latex','fontsize',35)
 % ylabel('Response to theta0 = 0 (AU)','Interpreter','Latex','fontsize',35) 
  end
